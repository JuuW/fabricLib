...
public class DatabaseIO {
	...
	// List<AccountMappingItem> mappingItems =
	// sess.createQuery("from AccountMappingItem order by id").list();
	// return mappingItems;
	// } finally {
	// sess.clear();
	// sess.close();
	 ...
	 * @return
	 */
	// protected static AccountMappingItem findAccMapItemsNoInCache(String key,
	// String type) {
	// Session sess = null;
	// try {
	// sess = MappingDataDBHepler.getDBSession();
	...
	// } else {
	// quary =
	// sess.createQuery("from AccountMappingItem where sapAccountID = :sapAccountID").setString(
	// "sapAccountID", key);
	// }
	// AccountMappingItem mappinogItem = (AccountMappingItem)
	// quary.setMaxResults(1).uniqueResult();
	// return mappingItem;
	// } catch (Throwable e) {
	...
	public static boolean update(Object item) throws Exception {
		boolean result  = false;
		Session sess = null;
		try {
	...
	// "common.accoutmapping.hibernate.cfg.xml";
	...
	// * @return
	// */
	// protected static AccountMappingItem getAccountMappingItem(String
	// sapAccountID,int sxYear) {
	// Session sess = null;
	// try {
	// sess = MappingDataDBHepler.getDBSession();
	// Query query =
	// sess.createQuery("from AccountMappingItem where sapAccountID = :sapAccountID and sxYear=:sxYear order by id")
	// .setString("sapAccountID", sapAccountID)
	// .setInteger("sxYear", sxYear);
	// AccountMappingItem mappingItems = (AccountMappingItem)
