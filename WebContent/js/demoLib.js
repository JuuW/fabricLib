...
// "sLengthMenu": "Dispdlay _MENU_ records"
	         "sLengthMenu": "Dispdlay "+showRecordNum+" records"
	       }
	...
	function modifyBarcode() {
		...
		$(".modifyBarcode").click(function(e) {
		 ...
		 if ( $(tr).hasClass('selected') ) {
			...
			$("#cancel_fabric").attr("href","index.html#0"+tds[1].html());
//			
...
// }
	...
	function addRow(tr, td) {
		...
		var htmlStr = "<tr class='fabric_extend'>" + "<td colspan='"
				...
				+ fabricExtid
				+ "' ><a href='index.html#0'>Modify</a></div>"
